...
Чтобы установить соединение с сервером **Omniscale OpenStreetMap WMS**, выполните команду главного меню **Слой > Добавить слой > Добавить слой WMS/WMTS** (Рисунок 23).
...
Данные сервера отобразятся в списке (Рисунок 25).
...
Данные сервера отобразятся во вкладке **Слои** (Рисунок 26).
...
В окне **Добавить слой WMT(S)** (Рисунок 39), в выпадающем списке выберите сервер **Omniscale OpenStreetMap WMS** и нажмите на кнопку **Подключиться**.
...
Ниже отобразится список слоев с указанного сервера (Рисунок 40).
...
.. figure:: _static/40.png
           ...
           Рисунок 40 – Включение слоя **Omniscale OpenStreetMap WMS**
...
В окне **Свойства слоя** (Рисунок 43) выберите вкладку **Общие**. В поле **Источник слоя** скопируйте путь к папке, в которой расположен растровый слой.
...
Слой отобразится в окне **Привязка слоя** (Рисунок 46).
