...
В рабочей области выделите щелчком мыши объект, который необходимо редактировать, и на панели **CITORUS.Link** нажмите на кнопку |image8| **Редактирование** (Рисунок 8).
